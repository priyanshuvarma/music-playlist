...
class Home extends Component {
  ...
  deleteHistory = id => {
    ...
    const updatedList = songsList.filter(eachList => eachList.id !== id)
    ...
    return (
      <>
        ...
        <div className="songs-list-container">
          ...
          <div className="overflow-container">{this.listItem()}</div>
        </div>
      </>
    )
  }
